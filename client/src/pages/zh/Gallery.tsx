...
export default function GalleryChinese() {
  const images = [
    { src: heroImg, alt: "Andatel Grande Exterior", category: "外观" },
    { src: poolImg1, alt: "Swimming Pool Experience", category: "泳池" },
    { src: roomImg1, alt: "Pool Access Room Interior", category: "客房" },
    { src: lifestyleImg1, alt: "Lifestyle at Andatel", category: "生活方式" },
  ];

  return (
    <Layout>
      <Helmet>
        <title>视觉画廊 | 普吉岛安达泰尔大酒店</title>
        <meta name="description" content="通过我们的视觉画廊探索安达泰尔大酒店的精致设计。查看我们的客房、泳池和芭东生活方式图片。" />
      </Helmet>
      <section className="bg-primary text-white py-32 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-xs font-sans tracking-[0.5em] text-accent uppercase font-black mb-8">视觉之旅</h2>
          <h1 className="text-6xl md:text-8xl font-serif mb-8 tracking-tight">画廊</h1>
          <p className="text-white/60 max-w-2xl mx-auto font-sans text-xl leading-relaxed">探索安达泰尔大酒店的精致设计与活力生活。</p>
        </div>
      </section>
